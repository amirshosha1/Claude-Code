...
App.seed = {
  ...
  vehicles: [{
    ...
    data: {
      ...
      /* ---- SUPPLIERS ---- */
      suppliers: [
        { name: 'ELKHLANY', contact: '+20 10 26840287', whatsapp: '+201026840287', website: '', brands: 'OEM + aftermarket', delivery: '', notes: 'Quotes: belt 650, idler 450, front shock 4800TR/3800CN, rear 3800, master 3500.' }
      ],
      /* ---- GARAGE INVENTORY ---- */
      inventory: [
