  ...
  vehicles: [{
    ...
    data: {
      ...
      parts: [
        ...
        { id: 'p-tens', name: 'Belt tensioner + idler', ar: 'شداد + بلي', oem: '55190813', fiat: '55190813', alt: 'INA/SKF/Gates', brand: 'INA', tier: 5, category: 'Engine', euRef: '€45–90', priceNewEg: 1150, supplier: 'El Asmar', laborEg: null, status: 'to-order', priority: 'high', vinOk: false, compat: 'Fiat 1.4 16v', verdict: 'buy', notes: 'El Asmar: full tensioner set 1,150 (idler pulley alone 450). ELKHLANY quoted idler-only at 450 — confirm which scope before ordering.' },
        { id: 'p-plugs', name: 'Spark plugs iridium ×4', ar: 'بوجيهات', oem: '55212466', fiat: '55212466', alt: 'NGK IKR9F8', brand: 'NGK', tier: 5, category: 'Engine', euRef: '€10–16 ea', priceNewEg: 3100, supplier: 'El Asmar', laborEg: null, status: 'to-order', priority: 'high', vinOk: true, compat: 'all 1.4 T-Jet', verdict: 'buy', qty: 1, notes: 'El Asmar: 3,100 for the ORIGINAL/توكيل set of 4 — NGK not in their stock currently. Price is for the full set, not per plug.' },
        ...
        { id: 'p-afilt', name: 'Air filter', ar: 'فلتر هواء', oem: '55192012', fiat: '55192012', alt: 'Mann/Mahle', brand: 'Mann', tier: 5, category: 'Engine', euRef: '€10–20', priceNewEg: 250, supplier: 'El Asmar', laborEg: null, status: 'to-order', priority: 'high', vinOk: false, compat: 'GP T-Jet (turbo airbox)', verdict: 'buy', notes: 'El Asmar quote: 250.' },
        ...
        { id: 'p-cowl', name: 'Cowl / scuttle panel', ar: 'فبرة المساحات', oem: '', fiat: 'via ePER', alt: 'genuine/used', brand: '', tier: 3, category: 'Body', euRef: '€15–40', priceNewEg: 1500, supplier: 'Italians House', laborEg: null, status: 'to-order', priority: 'medium', vinOk: false, compat: 'GP · Evo', verdict: 'buy', notes: 'Confirmed broken; protects BSI from water. Italians House quote: 1,500.' },
        { id: 'p-master', name: 'Brake master cylinder', ar: 'ماستر فرامل', oem: '', fiat: '', alt: 'LAST suspect', brand: '', tier: 0, category: 'Brakes', euRef: '—', priceNewEg: 3500, supplier: 'ELKHLANY', laborEg: null, status: 'hold', priority: 'low', vinOk: false, compat: '—', verdict: 'stop', notes: 'ELKHLANY quote 3,500; El Asmar ~3,000 (wants to see the Grande Punto specifically to confirm). DO NOT BUY — do rear brakes+fluid+calipers first.' },
        ...
        { id: 'p-rshock', name: 'Rear shocks pair', ar: 'مساعدين ورا', oem: '', fiat: 'via ePER', alt: 'KYB/Sachs/Monroe', brand: 'KYB', tier: 5, category: 'Suspension', euRef: '€35–60 ea', priceNewEg: 2500, supplier: 'Italians House', laborEg: null, status: 'hold', priority: 'medium', vinOk: false, compat: 'GP/Evo/Corsa D', verdict: 'hold', qty: 1, notes: 'Prices are per PAIR (both sides), qty=1. Italians House 2,500 · ELKHLANY 3,800 "original" (confirm brand) — inspect first before buying either.' },
        { id: 'p-fshock', name: 'Front struts pair', ar: 'مساعدين قدام', oem: '', fiat: 'via ePER', alt: 'KYB/Sachs (avoid Chinese)', brand: 'KYB', tier: 5, category: 'Suspension', euRef: '€60–100 ea', priceNewEg: 4800, supplier: 'ELKHLANY', laborEg: null, status: 'hold', priority: 'medium', vinOk: false, compat: 'GP/Evo/Corsa D', verdict: 'hold', qty: 1, notes: 'Prices are per PAIR (both sides), qty=1. ELKHLANY 4,800 Turkish / 3,800 Chinese · El Asmar ~6,000 Turkish set · Italians House 6,000 — inspect first; avoid Chinese regardless of price.' },
        ...
        { id: 'p-headunit', name: '9" Android head unit', ar: 'شاشة أندرويد', oem: '', fiat: '+canbus adapter', alt: 'X-max (ELHakim) / Winca / TS18', brand: 'X-max', tier: 4, category: 'Accessories', euRef: '€120–300', priceNewEg: 4750, supplier: 'ELHakim Car Hub', laborEg: 0, status: 'later', priority: 'cosmetic', vinOk: true, compat: 'GP 2-DIN + 199 canbus', verdict: 'later', notes: 'ELHakim X-max 2/32 = 4,750, price INCLUDES frame+camera+AHD+install+1yr warranty — no separate labor for this option. Alternatives: X-max 4/64=6,500 · SK Vision 2K=7,500 · Winca 2/32=6,500 (4/64=10,000) · TS18 varies 6,200–9,000 across sellers.' },
        { id: 'p-ambient', name: 'Ambient light kit', ar: 'إضاءة أمبيينت', oem: '', fiat: '', alt: '', brand: '', tier: 3, category: 'Accessories', euRef: '', priceNewEg: 1850, supplier: 'Screens — Alexandria', laborEg: null, status: 'later', priority: 'cosmetic', vinOk: true, compat: 'GP interior trim', verdict: 'later', notes: 'Quote: 1,850 (+20 11 12336552).' },
        { id: 'p-speakers', name: 'Door speakers ×4 (165mm)', ar: 'سماعات', oem: '', fiat: '6.5"', alt: 'Focal/JBL/Pioneer', brand: '', tier: 4, category: 'Accessories', euRef: '€40–120/pair', status: 'later', priority: 'cosmetic', vinOk: true, compat: 'GP doors', verdict: 'later', qty: 2, notes: 'No Egyptian dealer quote yet — EU reference only.' },
        { id: 'p-ledlow', name: 'LED low beam (pair)', ar: 'LED واطي', oem: '', fiat: 'check base', alt: 'Philips Ultinon/Osram', brand: 'Philips', tier: 5, category: 'Exterior', euRef: '€60–130', status: 'later', priority: 'cosmetic', vinOk: false, compat: 'match reflector', verdict: 'later', notes: 'No Egyptian dealer quote yet — EU reference only. Verify beam pattern on a wall.' },
        { id: 'p-leather', name: 'Leather seat covers (F+R)', ar: 'كسوة جلد', oem: '', fiat: 'upholstery', alt: 'local trimmer', brand: '', tier: 4, category: 'Interior', euRef: 'workshop', priceNewEg: 3700, supplier: 'Leather trim (+20 10 90421285)', laborEg: 0, status: 'later', priority: 'cosmetic', vinOk: true, compat: 'GP seats', verdict: 'later', notes: 'Quote 3,700 INSTALLED — labor is already included in this price, leave labor field at 0 for this item.' },
        { id: 'p-frontbumper', name: 'Front bumper', ar: 'اكصدام أمامي', oem: '', fiat: 'via ePER', alt: 'black available', brand: '', tier: 3, category: 'Body', euRef: '', priceNewEg: 4500, supplier: 'Italians House', laborEg: null, status: 'hold', priority: 'cosmetic', vinOk: false, compat: 'GP', verdict: 'hold', notes: 'Quote: 4,500. Only if the existing bumper can\'t be fiber+weld repaired economically.' },
        { id: 'p-rearbumper', name: 'Rear bumper (w/ lights)', ar: 'اكصدام خلفي بالفوانيس', oem: '', fiat: 'via ePER', alt: '', brand: '', tier: 3, category: 'Body', euRef: '', priceNewEg: 4000, supplier: 'Italians House', laborEg: null, status: 'hold', priority: 'high', vinOk: false, compat: 'GP', verdict: 'hold', notes: 'Quote: 4,000 incl. lights. This is the rear-impact panel — coordinate with the rear-harness CAN repair (§12), since that area needs to be opened anyway. Decide replace vs. fiber+weld once the electrician has assessed the damage.' }
      ],
